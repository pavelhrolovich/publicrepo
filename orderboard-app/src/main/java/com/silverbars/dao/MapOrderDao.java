...
public class MapOrderDao implements OrderDao {
    ...
    /**
     * I am using Concurrent HashMap to avoid ConcurrentModificationException because multiple threads could be reading and writing to this HashMap.
     ...
     *                                             1. If we don't recognise the supplied Order Id
        ...
        try {
            ...
            if (orderFound != null) {
                if (orderFound.getActive() == 'Y') {
                     ...
                     * In this application we know that the only change that can happen to the Order object is
                     ...
                     * I am assuming there just two entries in the audit list and trying to get the last audit entry
     ...
     *
     * @return Collection of Order Summary containing Order Quantity, Price and Order Type
     */
    @Override
